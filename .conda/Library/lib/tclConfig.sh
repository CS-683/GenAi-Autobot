...
# installed.
TCL_PREFIX='d:/Acads/Generative AI/Project/.conda\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='d:/Acads/Generative AI/Project/.conda\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='d:/Acads/Generative AI/Project/.conda\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-Id:/Acads/Generative AI/Project/.conda\Library\include'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-Ld:/Acads/Generative AI/Project/.conda\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='d:/Acads/Generative AI/Project/.conda\Library\lib\tclstub86.lib'
